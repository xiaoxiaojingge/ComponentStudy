 ...
 * @description 延迟队列配置 去官网下载延时队列插件：https://www.rabbitmq.com/community-plugins.html
 * 使用命令启用插件： linux：rabbitmq-plugins enable rabbitmq_delayed_message_exchange
...
public class DelayMQConfig {
	...
	/**
	 * 在 Exchange 的声明中可以设置exchange.setDelayed(true)来开启延迟队列， 也可以设置参数内容传入交换机声明的方法中，
