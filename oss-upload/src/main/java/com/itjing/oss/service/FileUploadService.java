package com.itjing.oss.service;

import com.aliyun.oss.OSS;
import com.aliyun.oss.OSSClientBuilder;
import com.aliyun.oss.model.OSSObject;
import com.aliyun.oss.model.ObjectMetadata;
import com.itjing.oss.config.AliyunOSSConfig;
import com.itjing.oss.response.StatusCode;
...
public class FileUploadService {
	...
	/*
	 * 文件上传
	 * 注：阿里云OSS文件上传官方文档链接：https://help.aliyun.com/document_detail/84781.html?spm=a2c4g.
	 * 11186623.6.749.11987a7dRYVSzn
	 *
	 * @param: uploadFile
	 *
	 * @return: string
	 *
	 * @create: 2021年05月14日 14:34
	 *
	 * @author: lijing
	 */
	public String upload(MultipartFile uploadFile) {
		...
		// 构建日期路径, 例如：OSS目标文件夹/2021/05/14/文件名
		...
		/**
		 * 下面两行代码是重点坑： 现在阿里云OSS 默认图片上传ContentType是image/jpeg
		 * 也就是说，获取图片链接后，图片是下载链接，而并非在线浏览链接， 因此，这里在上传的时候要解决ContentType的问题，将其改为image/jpg
		 */
