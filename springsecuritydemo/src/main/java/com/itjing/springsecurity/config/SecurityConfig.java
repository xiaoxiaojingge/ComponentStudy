package com.itjing.springsecurity.config;

import com.itjing.springsecurity.entity.User;
import com.itjing.springsecurity.service.UserService;
import com.itjing.springsecurity.util.StringUtil;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.authenticationProvider(new AuthenticationProvider() {
			...
			public Authentication authenticate(Authentication authentication) throws AuthenticationException {
				...
				password = StringUtil.md5(password + user.getSalt());
