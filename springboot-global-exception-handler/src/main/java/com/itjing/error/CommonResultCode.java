...
public class CommonResultCode implements ResultCode {
	...
	public static ResultCode resultCodeFactory(ResultCode resultCode, String msg) {
	...
	public static ResultCode UN_AUTHORIZED = new CommonResultCode(HttpServletResponse.SC_UNAUTHORIZED,
			"Request Unauthorized");

	public static ResultCode NOT_FOUND = new CommonResultCode(HttpServletResponse.SC_NOT_FOUND, "404 Not Found");

	public static ResultCode MSG_NOT_READABLE = new CommonResultCode(HttpServletResponse.SC_BAD_REQUEST,
			"Message Can't be Read");

	public static ResultCode METHOD_NOT_SUPPORTED = new CommonResultCode(HttpServletResponse.SC_METHOD_NOT_ALLOWED,
			"Method Not Supported");

	public static ResultCode MEDIA_TYPE_NOT_SUPPORTED = new CommonResultCode(
	...
	public static ResultCode INTERNAL_SERVER_ERROR = new CommonResultCode(HttpServletResponse.SC_INTERNAL_SERVER_ERROR,
			"Internal Server Error");

	public static ResultCode PARAM_MISS = new CommonResultCode(HttpServletResponse.SC_BAD_REQUEST,
			"Missing Required Parameter");

	public static ResultCode PARAM_TYPE_ERROR = new CommonResultCode(HttpServletResponse.SC_BAD_REQUEST,
			"Parameter Type Mismatch");

	public static ResultCode PARAM_BIND_ERROR = new CommonResultCode(HttpServletResponse.SC_BAD_REQUEST,
			"Parameter Binding Error");

	public static ResultCode PARAM_VALID_ERROR = new CommonResultCode(HttpServletResponse.SC_BAD_REQUEST,
