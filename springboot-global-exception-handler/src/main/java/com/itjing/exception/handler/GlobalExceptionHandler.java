...
public class GlobalExceptionHandler {
	...
	public GeneralResult<Object> restErrorHandler(HttpServletRequest request, BizException e) {
		String err = "requestURI:" + request.getRequestURI() + ",errorCode:" + e.getErrorCode() + ",errorMsg:"
				+ e.getErrorMsg();
		log.error(err, e);
	...
	public GeneralResult<Object> errorHandler(HttpServletRequest request, MethodArgumentNotValidException e) {
		...
		return GeneralResult.genErrorResult(err, CommonErrorEnum.BODY_NOT_MATCH.getErrorCode(), MDC.get("traceId"));
	}
	...
	public GeneralResult<Object> errorHandler(HttpServletRequest request, Exception e) {
		...
		return GeneralResult.genErrorResult(CommonErrorEnum.INTERNAL_SERVER_ERROR.getErrorMsg() + "->" + e.getMessage(),
