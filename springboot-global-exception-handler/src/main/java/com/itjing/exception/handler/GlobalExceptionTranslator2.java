...
import com.itjing.exception.PermissionDeniedException;
import com.itjing.exception.staffjoy.BaseResponse;
import com.itjing.exception.staffjoy.ResultCode;
import com.itjing.exception.staffjoy.ServiceException;
 ...
 * @Author: lijing
 * @CreateTime: 2022-09-30 09:36
 */
// @RestControllerAdvice
@Slf4j
public class GlobalExceptionTranslator2 {
	...
	public BaseResponse handleError(HttpMediaTypeNotSupportedException e) {
		...
		return BaseResponse.builder().code(ResultCode.MEDIA_TYPE_NOT_SUPPORTED).message(e.getMessage()).build();
	}
	...
	public BaseResponse handleError(Throwable e) {
		...
		return BaseResponse.builder().code(ResultCode.INTERNAL_SERVER_ERROR).message(e.getMessage()).build();
	}
