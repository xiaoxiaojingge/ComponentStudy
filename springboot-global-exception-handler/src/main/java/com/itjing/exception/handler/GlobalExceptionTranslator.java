...
import com.itjing.response.BaseResponse;
...
public class GlobalExceptionTranslator {
	...
	public BaseResponse handleServletException(Exception e) {
		...
		if (ENV_PROD.equals(profile)) {
			// String message = String.format("Missing Request Parameter: %s",
			// e.getParameterName());
			return BaseResponse.code(CommonResultCode.SERVER_ERROR).build();
		}
		return BaseResponse.code(CommonResultCode.resultCodeFactory(CommonResultCode.SERVER_ERROR, e.getMessage()))
			.build();
	}
	...
	public BaseResponse handleError(MethodArgumentTypeMismatchException e) {
		...
		return BaseResponse.code(CommonResultCode.resultCodeFactory(CommonResultCode.PARAM_TYPE_ERROR, message))
			.build();
	}
	...
	public BaseResponse handleError(MethodArgumentNotValidException e) {
		...
		return BaseResponse.code(CommonResultCode.resultCodeFactory(CommonResultCode.PARAM_VALID_ERROR, message))
			.build();
	}
	...
	public BaseResponse handleError(BindException e) {
		...
		String message = String.format("%s:%s", error.getField(), error.getDefaultMessage());
		return BaseResponse.code(CommonResultCode.resultCodeFactory(CommonResultCode.PARAM_BIND_ERROR, message))
			.build();
	}
	...
	public BaseResponse handleError(Throwable e) {
		...
		return BaseResponse.code(CommonResultCode.INTERNAL_SERVER_ERROR).build();
	}
