...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public AjaxResult exportExcel(List<T> list, String sheetName, HttpServletResponse response) throws IOException {
     ...
     * @return 结果
     */
    public AjaxResult importTemplateExcel(String sheetName, HttpServletResponse response) throws IOException {
     ...
     * @return 结果
     */
    public AjaxResult exportExcel(HttpServletResponse response) throws IOException {
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column) {
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                } else if (StringUtils.isNotEmpty(dictType) && Objects.nonNull(value)) {
