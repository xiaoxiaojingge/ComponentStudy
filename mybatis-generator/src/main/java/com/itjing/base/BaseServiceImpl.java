...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
	...
	public int updateByExampleSelective(@Param("record") Record record, @Param("example") Example example) {
		try {
			Method updateByExampleSelective = mapper.getClass()
	...
	public int updateByExample(@Param("record") Record record, @Param("example") Example example) {
		try {
			Method updateByExample = mapper.getClass()
	...
	public int insertOrUpdateSelective(Record record) {
		try {
			Method insertOrUpdateSelective = mapper.getClass()
				.getDeclaredMethod("insertOrUpdateSelective", record.getClass());
