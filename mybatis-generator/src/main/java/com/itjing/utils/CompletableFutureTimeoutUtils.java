...
public class CompletableFutureTimeoutUtils {
	...
	public static <T> CompletableFuture<T> completeOnTimeout(@NonNull CompletableFuture<T> future, T value,
	...
	public static <T> CompletableFuture<T> orTimeout(@NonNull CompletableFuture<T> future, long timeout,
	...
	public static void main(String[] args) throws ExecutionException, InterruptedException {
		...
		// CompletableFuture<String> within = completeOnTimeout(future, "超时", 3,
		// TimeUnit.SECONDS);
