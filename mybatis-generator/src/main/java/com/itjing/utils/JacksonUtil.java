...
public class JacksonUtil {
	...
	/**
	 * 设置序列化级别 NON_NULL：序列化非空的字段 NON_EMPTY：序列化非空字符串和非空的字段 NON_DEFAULT：序列化属性值发生过改变的字段
	 */
	...
	public static <V> V from(Object jsonObj, TypeReference<V> type) {
		try {
			...
			// log.error("jackson from error, json: {}, type: {}", jsonObj.toString(),
			// type, e);
			return null;
		}
	}
	...
	public static <V> V fromYamlRecource(String name, Class<V> c) {
		try (InputStream inputStream = getResourceStream(name);
			...
			// log.error("jackson from yaml recource error, name: {}, type: {}", name, c,
			// e);
			return null;
		}
	}
	...
	public static <V> V fromYamlRecource(String name, TypeReference<V> type) {
		try (InputStream inputStream = getResourceStream(name);
			...
			// log.error("jackson from yaml recource error, name: {}, type: {}", name,
			// type, e);
			return null;
		}
	}
	...
	public static <V> V fromPropRecource(String name, Class<V> c) {
		try (InputStream inputStream = getResourceStream(name);
			...
			// log.error("jackson from properties recource error, name: {}, type: {}",
			// name, c, e);
			return null;
		}
	}
	...
	public static <V> List<V> fromCsvRecource(String name, String separator, Class<V> c) {
		try (InputStream inputStream = getResourceStream(name);
			...
			// log.error("jackson from csv recource error, name: {}, type: {}", name, c,
			// e);
			return null;
		}
	}
	...
	public static <V> V fromXmlRecource(String name, Class<V> c) {
		try (InputStream inputStream = getResourceStream(name);
			...
			// log.error("jackson from xml recource error, name: {}, type: {}", name, c,
			// e);
			return null;
		}
	}
	...
	public static <V> V fromXmlRecource(String name, TypeReference<V> type) {
		try (InputStream inputStream = getResourceStream(name);
			...
			// log.error("jackson from xml recource error, name: {}, type: {}", name,
			// type, e);
			return null;
		}
	}
	...
	public static <V> void toPropFile(String path, V v) {
		try (Writer writer = new FileWriter(new File(path), true)) {
			...
			// log.error("jackson to properties file error, path: {}, obj: {}", path, v,
			// e);
		}
	}
	...
	public static <V> void toCsvFile(String path, String separator, List<V> list) {
		try (Writer writer = new FileWriter(new File(path), true)) {
			...
			// log.error("jackson to csv file error, path: {}, separator: {}, list: {}",
			// path, separator, list, e);
		}
	}
	...
	public static <V> void toCsvFile(String path, String separator, V v) {
		try (Writer writer = new FileWriter(new File(path), true)) {
			...
			// log.error("jackson to csv file error, path: {}, separator: {}, obj: {}",
			// path, separator, v, e);
		}
	}
	...
	public static <V> void toXmlFile(String path, V v, boolean isIndent) {
		try (Writer writer = new FileWriter(new File(path), true)) {
			...
			// log.error("jackson to xml file error, path: {}, obj: {}, isIndent: {}",
			// path, v, isIndent, e);
		}
	}
	...
	public static String getString(String json, String key) {
		...
		try {
			...
			// log.error("jackson get string error, json: {}, pullWaybillKey: {}", json,
			// key, e);
			return null;
		}
	}
	...
	public static Integer getInt(String json, String key) {
		...
		try {
			...
			// log.error("jackson get int error, json: {}, pullWaybillKey: {}", json, key,
			// e);
			return null;
		}
	}
	...
	public static Long getLong(String json, String key) {
		...
		try {
			...
			// log.error("jackson get long error, json: {}, pullWaybillKey: {}", json,
			// key, e);
			return null;
		}
	}
	...
	public static Double getDouble(String json, String key) {
		...
		try {
			...
			// log.error("jackson get double error, json: {}, pullWaybillKey: {}", json,
			// key, e);
			return null;
		}
	}
	...
	public static BigInteger getBigInteger(String json, String key) {
		...
		try {
			...
			// log.error("jackson get biginteger error, json: {}, pullWaybillKey: {}",
			// json, key, e);
			return null;
		}
	}
	...
	public static BigDecimal getBigDecimal(String json, String key) {
		...
		try {
			...
			// log.error("jackson get bigdecimal error, json: {}, pullWaybillKey: {}",
			// json, key, e);
			return null;
		}
	}
	...
	public static boolean getBoolean(String json, String key) {
		...
		try {
			...
			// log.error("jackson get boolean error, json: {}, pullWaybillKey: {}", json,
			// key, e);
			return false;
		}
	}
	...
	public static byte[] getByte(String json, String key) {
		...
		try {
			...
			// log.error("jackson get byte error, json: {}, pullWaybillKey: {}", json,
			// key, e);
			return null;
		}
	}
	...
	public static <T> String add(String json, String key, T value) {
		try {
			...
			// log.error("jackson add error, json: {}, pullWaybillKey: {}, value: {}",
			// json, key, value, e);
			return json;
		}
	}
	...
	public static String remove(String json, String key) {
		try {
			...
			// log.error("jackson remove error, json: {}, pullWaybillKey: {}", json, key,
			// e);
			return json;
		}
	}
	...
	public static <T> String update(String json, String key, T value) {
		try {
			...
			// log.error("jackson update error, json: {}, pullWaybillKey: {}, value: {}",
			// json, key, value, e);
			return json;
		}
	}
	...
	public static void main(String[] args) {
		...
		article.setAuthor("lijing");
		article.setContent("I love you");
		System.out.println(JacksonUtil.to(article));

		String jsonStr = "{\"author\":\"lijing\",\"content\":\"I love you\"}";
		System.out.println(JacksonUtil.from(jsonStr, Article.class));
	}
