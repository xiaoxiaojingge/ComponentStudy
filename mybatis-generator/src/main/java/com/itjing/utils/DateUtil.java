...
public class DateUtil {
	 ...
	 * @throws Exception
	 */
	public static Date getLastSecondOfCurrentMonth() throws Exception {
		Calendar now = Calendar.getInstance();
	...
	/**
	 * 根据毫秒数转换为时间字符串： xxx时xxx分xxx秒 毫秒数不是时间，比如： 1000 ，转换成 1秒
	 * @param millisecond
	 * @return
	 */
	...
	/**
	 * java时间字符串去空格、冒号和横杠 将 1609139732636 转换成 20201228151532636
	 * @param seconds
	 * @return
	 */
