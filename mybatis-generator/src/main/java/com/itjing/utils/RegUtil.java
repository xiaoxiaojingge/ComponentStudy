...
public class RegUtil {
	 ...
	 * 英文单词
	 */
	public static final String ENGLISHWORD = "\\d+.\\d+|\\w+";
	...
	/**
	 * 复杂日期，不区分闰年的2月 日期格式：2017-10-19 或2017/10/19 或2017.10.19 或2017年10月19日
	...
	/**
	 * 复杂的日期，区分闰年的2月 这个日期校验能区分闰年的2月，格式如下：2017-10-19
	...
	/**
	 * 提取中英文混合字符串中的英文单词 用*拼接
	 * @param str
	 */
	public static String getStringWord(String str) {

		Pattern pattern = Pattern.compile(ENGLISHWORD);
		Matcher ma = pattern.matcher(str);
		StringBuffer stringBuffer = new StringBuffer();
		while (ma.find()) {
			stringBuffer.append("*" + ma.group());
		}
