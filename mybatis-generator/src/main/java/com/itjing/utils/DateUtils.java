...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static final SimpleDateFormat SHORT_DATE_TIME_FORMAT = new SimpleDateFormat("yyyyMMddHHmmss");

    public static final SimpleDateFormat MILLI_DATE_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
    public static final SimpleDateFormat SHORT_MILLI_DATE_TIME_FORMAT = new SimpleDateFormat("yyyyMMdd HHmmssSSS");

    public static final SimpleDateFormat HHMMSS_FORMAT = new SimpleDateFormat("HHmmss");
     ...
     * @return
     */
    public static String getShortDateStr(Timestamp timestamp) {
        return YYYYMMDD_FORMAT.format(timestamp);
    }
     ...
     * @return
     */
    public static String getDateStr(Timestamp tmp) {
        return YYYY_MM_DD_FORMAT.format(tmp);
    }


    /**
     * 获取当前时间短日期格式(yyyyMMdd HHmmss)字串
     *
     * @return
     */
    public static String getShortDateTimeStr() {
        return SHORT_DATE_TIME_FORMAT.format(new Date());
    }
     ...
     * @return
     */
    public static String getShortDateTimeStr(Date date) {
        return SHORT_DATE_TIME_FORMAT.format(date);
    }

    /**
     * 获取指定时间短日期格式((yyyyMMdd HHmmss))字串
     *
     * @param time 当前时间戳
     * @return
     */
    public static String getShortDateTimeStr(Timestamp time) {
        return SHORT_DATE_TIME_FORMAT.format(time);
    }


    /**
     * 获取当前时间长日期格式(yyyy-MM-dd HH:mm:ss)字串
     *
     * @return
     */
    ...
    /**
     * 获取指定时间长日期格式((yyyy-MM-dd HH:mm:ss))字串
     *
     * @param time 当前时间戳
     * @return
     */
    public static String getDateTimeStr(Timestamp time) {
        return DEFAULT_DATE_TIME_FORMAT.format(time);
    }
    ...
    public static Timestamp getTimestamp(Date date) {
        return Timestamp.valueOf(DEFAULT_DATE_TIME_FORMAT.format(date));
    }
     ...
     * @return
     */
    public static String getShortTimeStr(Timestamp timestamp) {
        return HHMMSS_FORMAT.format(timestamp);
    }
    ...
    public static String getTimeStr(Timestamp timestamp) {
        return HH_MM_SS_FORMAT.format(timestamp);
    }
     ...
     * @return
     */
    public static int getYearStr(Date date) {
    ...
    public static Date subDays(int days) {
        ...
        String dateStr = getDateTimeStr(date);
        Date date1 = null;
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        try {
    ...
    public static long getDateDiff(Date date1, Date date2) {
        if (Objects.isNull(date1) || Objects.isNull(date1)) {
            return 0L;
        }
    ...
    public static List<String> getLastDays(int countDay) {
        ...
        for (int i = 0; i < countDay; i++) {
            listDate.add(DateUtils.getShortDateStr(DateUtils.getDate(-i)));
        }
        return listDate;
    }
    ...
    private static String toString(Date dt, SimpleDateFormat formatter) {
        ...
        try {
            ...
            log.error("转换java.util.Date到String", e);
            sRet = null;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(DateUtils.nowTimeMillis());
        ...
        System.out.println(DateUtils.getDateStr(DateUtils.getTimestamp()));

        /**
         * getShortDateStr()
         */
        System.out.println("\ngetShortDateStr()");
        System.out.println(DateUtils.getShortDateStr());
        System.out.println(DateUtils.getShortDateStr(new Date()));
        System.out.println(DateUtils.getShortDateStr(DateUtils.getTimestamp()));

        /**
         * getDateTimeStr()
         */
        System.out.println("\ngetDateTimeStr()");
        System.out.println(DateUtils.getDateTimeStr());
        System.out.println(DateUtils.getDateTimeStr(new Date()));
        System.out.println(DateUtils.getDateTimeStr(DateUtils.getTimestamp()));

        /**
         * getShortDateTimeStr()
         */
        System.out.println("\ngetShortDateTimeStr()");
        System.out.println(DateUtils.getShortDateTimeStr());
        System.out.println(DateUtils.getShortDateTimeStr(new Date()));
        System.out.println(DateUtils.getShortDateTimeStr(DateUtils.getTimestamp()));
        ...
        System.out.println(DateUtils.getTimestamp("2019-9-21 13:20:52"));

        /**
         * getTime()
         */
        System.out.println("\ngetTime()");
        System.out.println(DateUtils.getTimeStr());
        System.out.println(DateUtils.getTimeStr(new Date()));
        System.out.println(DateUtils.getTimeStr(DateUtils.getTimestamp()));

        /**
         * getShortTime()
         */
        System.out.println("\ngetShortTime()");
        System.out.println(DateUtils.getShortTimeStr());
        System.out.println(DateUtils.getShortTimeStr(new Date()));
        System.out.println(DateUtils.getShortTimeStr(DateUtils.getTimestamp()));

        /**
         * getDayStart()
         */
        System.out.println("\ngetDayStart()");
        System.out.println(DateUtils.toString(DateUtils.getDayStart(new Date()), DateUtils.DEFAULT_DATE_TIME_FORMAT));


        /**
         * getMonthStart() && getFirstDateOfMonth()
         */
        System.out.println("\ngetMonthStart() && getFirstDateOfMonth()");
        System.out.println(formatDate(getMonthStart(new Date())));
        System.out.println(formatDate(getFirstDateOfMonth(new Date())));

        /**
         *getMonthEnd()
         */
        System.out.println("\ngetMonthEnd()");
        System.out.println(toString(DateUtils.getMonthEnd(new Date()), DateUtils.DEFAULT_DATE_TIME_FORMAT));

        /**
         * parseDate
         */
        try {
            DateUtils.parseDate("2019-09-21", "yyyy-MM-dd");
        } catch (ParseException e) {
            e.printStackTrace();
        }
