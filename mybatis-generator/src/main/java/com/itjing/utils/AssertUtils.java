...
public class AssertUtils {
	...
	public static <T, E extends RuntimeException> void isTrue(T caller, T reference, BiPredicate<T, T> verifier,
			Supplier<E> exSupplier) {
		// 断言结果
	...
	public static void main(String[] args) {
		...
		AssertUtils.isTrue(new BigDecimal(1), new BigDecimal(2), AssertUtils::isLe,
				() -> new RuntimeException("要求xxx"));
	}
