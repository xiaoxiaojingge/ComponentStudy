...
/**
 * 红包过期失效 高可用延迟队列 https://blog.52itstyle.vip/archives/5163/
 */
public class RedPacketDelayQueue {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 红包目标队列
		 */
		RBlockingQueue<RedPacketMessage> blockingRedPacketQueue = redissonClient
			.getBlockingQueue("redPacketDelayQueue");
		/**
		 * 定时任务将到期的元素转移到目标队列
		 */
