...
/**
 * @author lijing
 * @date 2022年06月26日 10:59
 * @description HttpClient工具类 在编写工具类的时候，需要注意的地方是， 尽可能保证httpClient客户端全局唯一，也就是采用单例模式，
 * 如果每次请求都初始化一个客户端，结束之后又将其关闭， 在高并发的接口请求场景下，性能效率急剧下降！
 */
@Slf4j
public class HttpUtils {
	...
	public static RequestResult postUploadFileStream(String url, Map<String, String> header, Map<String, String> param,
		...
		String infoMessage = new StringBuilder().append("request postUploadFileStream，url:")
			.append(url)
			.append("，header:")
	...
	public static RequestResult sendPostForm(String url, Map<String, String> header, Map<String, String> param) {
		String infoMessage = new StringBuilder().append("request postForm，url:")
			.append(url)
			.append("，header:")
	...
	public static String sendHttp(HttpMethod httpMethod, String url, Map<String, String> header, String params) {
		String infoMessage = new StringBuilder().append("request sendHttp，url:")
			.append(url)
			.append("，method:")
