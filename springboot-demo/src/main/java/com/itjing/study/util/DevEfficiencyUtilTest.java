...
public class DevEfficiencyUtilTest {
    ...
    /**
     * 测试java.util.Collections
     * Collections方法有很多，这里只测试部分
     */
    @Test
...
//        Integer integer2 = null;
    ...
    /**
     * 测试Apache下的BooleanUtils
     * BooleanUtils类的方法有很多，这里只测试部分
     */
    @Test
    ...
    /**
     * 测试Apache下的StringUtils
     * StringUtils类的方法有很多，这里只测试部分
     */
    @Test
    ...
    /**
     * Spring提供了Assert类，它表示断言。
     * Assert类的方法有很多，这里只测试部分
     */
    @Test
    ...
    public void testApacheIOUtils() throws IOException {
        {
            ...
            String str = IOUtils.toString(new FileInputStream("E:\\workspace_idea\\programmer-evolution-house-nav\\programmer-evolution-house-nav-admin\\src\\main\\resources\\banner.txt"), StandardCharsets.UTF_8);
...

        {
            ...
            String str = "abcde";
            IOUtils.write(str, new FileOutputStream("E:\\workspace_idea\\ComponentStudy\\springboot-demo\\src\\main\\resources\\a.txt"), StandardCharsets.UTF_8);
        }

        {
            ...
            IOUtils.copy(
                    new FileInputStream("E:\\workspace_idea\\programmer-evolution-house-nav\\programmer-evolution-house-nav-admin\\src\\main\\resources\\banner.txt"),
                    new FileOutputStream("E:\\workspace_idea\\ComponentStudy\\springboot-demo\\src\\main\\resources\\a.txt")
            );
        }

        {
            ...
            byte[] bytes = IOUtils.toByteArray(new FileInputStream("E:\\workspace_idea\\programmer-evolution-house-nav\\programmer-evolution-house-nav-admin\\src\\main\\resources\\banner.txt"));
        }
    }
