package com.itjing.dataStructureStudy.linkedlist.josepfu;

/**
 * @author: lijing
 * @Date: 2021年09月18日 8:54
 * @Description:
 */
	...
	public void addBoy(int nums) {
		...
		for (int i = 1; i <= nums; i++) {// i从1开始,才能得到编号与数字顺序一样的no;
			...
			if (i == 1) { // 如果fori从0开始遍历,这里也要改为i==0,否则下面 `curBoy.setNext(boy);`将空指针异常
				...
				curBoy.setNext(boy);// 此处curBoy标记的是上一次循环的boy
									// 如`i==2`-->curBoy==first、`i==3`-->curBoy==boy(第二个)
