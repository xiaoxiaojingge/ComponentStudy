 ...
 * @Description: List 可谓是我们经常使用的集合类之一，几乎所有业务代码都离不开 List。
 * 既然天天在用，那就没准就会踩中这几个 List 常见坑。
 */
public class List常见坑 {
    ...
    public static void testArraysAsList2() {
        ...
        list.set(0, "modify_1");
        arrays[1] = "modify_2";
        System.out.println("arrays:" + Arrays.toString(arrays)); // arrays:[modify_1, modify_2, 3]
