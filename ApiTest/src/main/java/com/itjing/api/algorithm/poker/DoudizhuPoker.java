...
public class DoudizhuPoker {
	...
	enum CardType {
		...
		SINGLE, DOUBLE, THREE, BOMB, JOKER_BOMB, THREE_ONE, THREE_TWO, BOMB_TWO, BOMB_TWOOO, CONNECT, COMPANY, AIRCRAFT,
		AIRCRAFT_SINGLE, AIRCRAFT_DOUBLE, ERROR_CARD
	...
	public CardType input(Poker... pokers) {
		...
		PokerList.AnalyseResult analyse = pokerList.analyse();
		// 判断四张牌数量大于 0 的
