...
/**
 * 作者: sanri 时间: 2017/08/10 21:20 功能: 动态编译类文件例子
 */
public class DynamicCompileExample {

	@Test
	public void testMainRun() throws IOException, ClassNotFoundException, NoSuchMethodException,
			InvocationTargetException, IllegalAccessException, InstantiationException {
		String code = "package com.sanri.test.deginmodel.proxy.static_; \n public class $Proxy1 implements  Moveable {\n"
		...
		Class clazz = classLoader.loadClass("com.sanri.test.deginmodel.proxy.static_.$Proxy1");
