...
/**
 * 这个用来测试是不是这样进行热更新的 显然类加载后是在堆中有缓存的,不可能重新加载就更新类,热更新在 tomcat 中是重新创建一个类加载器来加载 或者使用
 * attachment 来加载如 arthas 和 jmap 类的工具,这个我就没有仔细去看了
 */
public class TestClassLoader {
	...
	public void testRefClass()
			throws ClassNotFoundException, MalformedURLException, NoSuchFieldException, IllegalAccessException {
