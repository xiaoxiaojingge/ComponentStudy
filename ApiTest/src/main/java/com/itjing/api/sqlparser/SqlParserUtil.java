...
import com.itjing.api.sqlparser.items.SqlSelectItem;
import com.itjing.api.sqlparser.items.SqlStatement;
...
public class SqlParserUtil {
	...
	public static void main(String[] args) throws JSQLParserException {
		SqlStatement sqlStatement = parser("select a,b,c from table_student s "
				...
				+ "inner join table_other o on o.idcard = s.idcard or o.mm = s.mm " + "where a =1");
