...
public class SqlParserTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// String sql = "select t1.a,t2.b from table1 t1 left join table2 t2 on t1.a =
		// t2.b";
		// String sql = "select *from (select t1.a,t2.b from table1 t1 left join table2 t2
		// on t1.a = t2.b) a";

		// String sql = "select t1.a,t2.b from table1 t1 left join table2 t2 on t1.a =
		// t2.b left join table3 t3 on t2.c=t3.d where t1.a = ?";
		// String sql = "select t1.a,t2.b from table1 as t1,table2 as t2,table3 t3 where
		// t1.a = t2.b and t2.c=t3.d and t1.a = ?";
	...
	private static void doExpression(Expression expression) {
		if (expression instanceof EqualsTo) {
			...
			if (rightExpression instanceof Column && leftExpression instanceof Column) {
				...
				System.out.println(tableMap.get(rightColumn.getTable().toString()) + "表的" + rightColumn.getColumnName()
						+ "字段 -> " + tableMap.get(leftColumn.getTable().toString()) + "表的" + leftColumn.getColumnName()
						+ "字段");
			}
		}
