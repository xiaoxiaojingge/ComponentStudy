...
public class StreamMain {
	...
	@Test
	public void filter() {
		List<Vehicle> collect = vehicles.stream()
			.filter(vehicle -> vehicle.getScore() >= 3)
	...
	public void sortBy() {
		...
		// List<Vehicle> collect =
		// vehicles.stream().sorted(Comparator.comparing(Vehicle::getScore).reversed()).collect(Collectors.toList());
		// collect.forEach(System.out::println);

		List<Vehicle> collect = vehicles.stream()
			.sorted(Comparator.comparing(Vehicle::getScore)
				.reversed()
	 ...
	 */
	public void toMap() {
		Map<String, Vehicle> vinVehicles = vehicles.stream()
			.collect(Collectors.toMap(Vehicle::getVin, vehicle -> vehicle));
	}
