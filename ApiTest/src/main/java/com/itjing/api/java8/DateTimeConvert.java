...
public class DateTimeConvert {
	...
	public void toLocalDate() {
		// Date转LocalDate
		// LocalDate dateLocalDate = LocalDate.ofInstant(date.toInstant(),
		// ZoneId.systemDefault()); //jdk11
		...
		// Calendar转LocalDate
		// LocalDate calendarLocalDate = LocalDate.ofInstant(calendar.toInstant(),
		// ZoneOffset.systemDefault()); //jdk11
		LocalDate calendarLocalDate = LocalDateTime.ofInstant(calendar.toInstant(), ZoneOffset.systemDefault())
			.toLocalDate();
		// Instant转LocalDate
		// LocalDate instantLocalDate = LocalDate.ofInstant(instant,
		// ZoneId.systemDefault()); //jdk11
	...
	public void toCalendar() {
		...
		Calendar localDateTimeCalendar = GregorianCalendar
