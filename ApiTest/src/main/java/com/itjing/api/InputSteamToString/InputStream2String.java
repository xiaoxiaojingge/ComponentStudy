...
//        inputStream2StringSeven();
    ...
    public static void inputStream2StringOne() {
        try {
            // 路径修改为本地文件所在的位置
            InputStream inputStream = new FileInputStream("E:\\workspace_idea\\ComponentStudy\\ApiTest\\src\\main\\resources\\testFile.txt");
            // 根据需要的数组大小进行自定义
    ...
    public static void inputStream2StringSix() {
        try {
            // 路径修改为本地文件所在的位置
            InputStream inputStream1 = new FileInputStream("E:\\workspace_idea\\ComponentStudy\\ApiTest\\src\\main\\resources\\testFile.txt");
            String myString1 = new BufferedReader(new InputStreamReader(inputStream1))
                    .lines().collect(Collectors.joining("\n"));

            InputStream inputStream2 = new FileInputStream("E:\\workspace_idea\\ComponentStudy\\ApiTest\\src\\main\\resources\\testFile.txt");
            String myString2 = new BufferedReader(new InputStreamReader(inputStream2))
