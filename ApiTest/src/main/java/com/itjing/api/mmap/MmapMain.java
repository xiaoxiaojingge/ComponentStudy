...
public class MmapMain {
	...
	public void mapFile() throws IOException {
		// 这个文件一定要存在
		MappedByteBuffer mappedByteBuffer = Files.map(new File("d:/tmp/sanri-sanritools.log"),
	...
	public void testFileChannelTrans() throws IOException {
		try (FileChannel fromChannel = new RandomAccessFile("d:/test/source.txt", "rw").getChannel();
