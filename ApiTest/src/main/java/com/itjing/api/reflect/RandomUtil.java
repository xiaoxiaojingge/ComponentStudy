...
public class RandomUtil extends RandomStringUtils {
	...
	public static final String[] PHONE_SEGMENT = "133,149,153,173,177,180,181,189,199,130,131,132,145,155,156,166,171,175,176,185,186,166,135,136,137,138,139,147,150,151,152,157,158,159,172,178,182,183,184,187,188,198,170"
		.split(",");
	...
	/**
	 * 功能:生成 length 个中文 <br/>
	 * 创建时间:2016-4-16上午11:24:40 作者：sanri
	 */
	...
	public static String photoURL() {
		// 这个是已经找好的图片地址
		String[] urls = { "http://img1.imgtn.bdimg.com/it/u=2346282507,2171850944&fm=26&gp=0.jpg",
	...
	public static String url() {
		String[] urls = { "https://www.baidu.com/", "https://blog.csdn.net/", "https://segmentfault.com/",
				"https://www.cnblogs.com/", "https://www.jianshu.com/" };
		int index = RandomUtils.nextInt(0, urls.length);
		return urls[index];
	}
