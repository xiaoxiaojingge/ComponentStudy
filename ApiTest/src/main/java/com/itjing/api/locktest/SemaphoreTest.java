...
public class SemaphoreTest {
	...
	/**
	 * Semaphore初始化有10个令牌，11个线程同时各调用1次acquire方法，会发生什么？ 会有一个线程被阻塞
	 */
	@Test
	...
	/**
	 * Semaphore初始化有10个令牌，一个线程重复调用11次acquire方法，会发生什么？ 会获取 10 次令牌，最后一个没有令牌了，阻塞
	 */
	@Test
	...
	/**
	 * Semaphore初始化有2个令牌，一个线程调用1次release方法，然后一次性获取3个令牌，会获取到吗？ 可以取到， release 就相相于加一个令牌
	 */
	@Test
