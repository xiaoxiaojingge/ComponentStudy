...
/**
 * 使用这个客户端会更方便，更容易和 springboot 结合 <dependency> <groupId>com.github.tobato</groupId>
 * <artifactId>fastdfs-client</artifactId> </dependency> 目前为了展示其完整过程用的这个包
 *
 * <groupId>org.csource</groupId> <artifactId>fastdfs-client-java</artifactId>
...
//
// String result = client.upload_appender_file1(null, file.length(), new
// UploadStream(fileInputStream, file.length()), extension, null);
...
// @Cleanup FileOutputStream fileOutputStream = new
// FileOutputStream("d:/test/EZC9kAAAAADTw1dU724.log");
