...
public class HttpClientMain {
	...
	public void testHttps() throws IOException {
		...
		try {
			...
			Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder.<ConnectionSocketFactory>create()
				...
				// AllowAllHostnameVerifier 用于解决 httpclient hostname in certificate didn't
				// match:
		...
		HttpGet httpGet = new HttpGet(
				"https://10.101.70.202/scp-st-informationreleaseapp/20200622/15927903519247umbDuff66.mp4");
	...
	public void postJsonData() throws IOException {
		...
		HttpEntity httpEntity = new StringEntity(JSON.toJSONString(o),
	...
	public void testMultipart() throws IOException {
		...
		HttpEntity httpEntity = MultipartEntityBuilder.create()
			.addTextBody("idcard", RandomUtil.idcard())
			.addPart("file", new FileBody(new File("d:/sanritoolsplugins.rar")))
			.build();
