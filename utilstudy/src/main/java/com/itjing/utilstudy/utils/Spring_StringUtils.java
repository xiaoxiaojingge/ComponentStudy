...
public class Spring_StringUtils {
	...
	public static void main(String[] args) {
		...
		System.out.println(StringUtils.unqualify("com/itjing/Hello.java", '/')); // Hello.java
		...
		System.out.println(StringUtils.applyRelativePath("d:/java/itjing/Test.java", "other/Some.java"));
		...
		System.out.println(StringUtils.cleanPath("d:/java/itjing/../other/Some.java"));

		// 需求：获取d:/java/itjing/Test.java相对路径为../../other/Some.java的文件全路径：
		// 打印：d:/other/Some.java
		System.out.println(StringUtils
			.cleanPath(StringUtils.applyRelativePath("d:/java/itjing/Test.java", "../../other/Some.java")));
