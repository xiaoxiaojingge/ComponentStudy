...
public class OptionalDemo {
	...
	/**
	 * 创建Optional实例 Optional.of(T value)：不能传null，否则报错
	 */
	@Test
	...
	/**
	 * 创建Optional实例 Optional.empty() 创建一个空的Optional
	 */
	@Test
	...
	/**
	 * 创建Optional实例 Optional.ofNullable(T value)： 如果value是null，则返回Optional.empty()；
