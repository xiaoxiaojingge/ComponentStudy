package com.itjing.flowable.controller;
...
public class HelloController {
	...
	public void showPic(HttpServletResponse resp, String processId) throws Exception {
		...
		// activityIds, flows, engconf.getActivityFontName(), engconf.getLabelFontName(),
		// engconf.getAnnotationFontName(), engconf.getClassLoader(), 1.0, false);
		// 用上面的配置，字体会乱码
		InputStream in = diagramGenerator.generateDiagram(bpmnModel, "png", activityIds, flows, "宋体", "宋体", "宋体",
