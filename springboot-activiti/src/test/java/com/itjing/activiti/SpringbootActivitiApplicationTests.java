...
class SpringbootActivitiApplicationTests {
	...
	public void testCreateDbTable() {
		/**
		 * 创建 processEngine 时，会自动加载 /resources 目录下的 activiti.cfg.xml 文件 进行 mysql 数据库中表的创建
		 */
	...
	/**
	 * 删除流程定义 注意：如果流程没有完成，需要特殊处理：级联删除
	 */
	 ...
	 * 启动流程 -- RuntimeService
	 * <p>
	 * ACT_HI_TASKINST 任务实例历史信息 ACT_HI_PROCINST 流程实例历史信息 ACT_HI_ACTINST 活动实例历史信息
	 * <p>
	 * ACT_HI_IDENTITYLINK 流程的用户参与历史信息 ACT_RU_EXECUTION 流程正在执行信息 ACT_RU_TASK 任务信息
	...
	public void testFindPersonalTaskList() {
		...
		List<Task> taskList = taskService.createTaskQuery().processDefinitionKey(key).taskAssignee("zhangsan").list();
