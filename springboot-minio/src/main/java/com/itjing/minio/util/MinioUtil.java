...
public class MinioUtil {
	...
	public UploadResponse uploadFile(MultipartFile file, String bucketName) throws Exception {
		...
		String urlHost = minioConfig.getNginxHost() + "/" + bucketName + "/" + fileName;
	...
	public Optional<Bucket> getBucket(String bucketName)
			...
			InvalidResponseException, InternalException, ErrorResponseException, ServerException, XmlParserException {
	 ...
	 * @param stream ⽂件流
	 * @throws Exception
	 * https://docs.minio.io/cn/java-minioClient-api-reference.html#putObject
	 */
	 ...
	 * @param objectName ⽂件名称
	 * @throws Exception
	 * https://docs.minio.io/cn/java-minioClient-api-reference.html#statObject
	 */
	 ...
	 * @param objectName ⽂件名称
	 * @throws Exception
	 * https://docs.minio.io/cn/java-minioClient-apireference.html#removeObject
	 */
